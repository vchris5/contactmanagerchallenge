...
{
    /// <summary>
    /// Represents the database context for the Contact Manager application.
    /// </summary>
    public class ApplicationContext : DbContext
    {
        ...
        {
            // Index and filter applied to ensure uniqueness for primary emails
            modelBuilder.Entity<EmailAddress>()
                .HasIndex(e => new { e.IsPrimary, e.ContactId })
                .HasFilter("IsPrimary = 1")
                .IsUnique();

            // Seed data for three contacts
            var bill =
                new Contact
                {
            ...
            // Applied to ensure is a primary emails
